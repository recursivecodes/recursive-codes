                    ...
                    <bootform:field field="article" required="true" labelColumnClass="col-sm-2" controlColumnClass="col-sm-8" bean="${command}" description="">
                        <div id="toolbar" style="display: none;" class="pad-bottom-10">
                            <div class="btn-group">
                                ...
                                -->
                                <a class="btn btn-sm btn-default upload-s3-trigger" data-toggle="tooltip" rv-on-click="model.showS3UploadModal" data-container="body" title="Upload To Object Storage" href="javascript:;" unselectable="on"><i class="fa fa-upload"></i>
                                </a>
                            </div>
